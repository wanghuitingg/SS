...
export const constantRoutes = [
    ...
    children: [
      {
        ...
        meta: { title: '测试页面一', icon: 'table' }
      },{
        path: 'testtwo',
        name: 'TestTwo',
        component: () => import('@/views/test_page/test2'),
        meta: { title: '测试页面二', icon: 'table' }
      },
  ...
  },
  {
    path: '/level',
    component: Layout,
    redirect: '/level/addLevel',
    name: 'TestPage',
    meta: { title: '等级管理', icon: 'el-icon-s-help' },
    children: [
      {
        path: 'addLevel',
        name: 'AddLevel',
        component: () => import('@/views/level/addLevel'),
        meta: { title: '添加等级', icon: 'table' }
      },{
        path: 'levellist',
        name: 'levelList',
    ...
    name: 'address',
    meta: { title: '地址管理', icon: 'el-icon-s-help' },
    children: [
      {
        path: 'add',
        name: 'addAddress',
        component: () => import('@/views/address/add_address'),
        meta: { title: '添加地址', icon: 'table' }
      },{
        path: 'list',
        name: 'addressList',
